...
class War {
    ...
    vikingAttack(){
        ...
        let vAttack = this.saxonArmy[battlingSaxon].receiveDamage(this.vikingArmy[battlingViking].attack());
    ...
    saxonAttack(){
        ...
        let sAttack = this.vikingArmy[battlingViking].receiveDamage(this.saxonArmy[battlingSaxon].attack());
